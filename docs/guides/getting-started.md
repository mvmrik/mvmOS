...
mvmOS runs on Linux with systemd and Python 3.10 or later. It is a browser desktop served by a small Python service; it does not require Node.js, a build step, or a graphical Linux desktop on the server.
...
Read [[Security and access]], [[Updates]], and [[Mobile and PWA]] before using an internet-facing installation from multiple devices.
